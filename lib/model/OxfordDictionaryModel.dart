  ...
  TranslationsResponse.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        results.add(HeadwordEntry.fromJson(v));
      });
    }
  }
}
  ...
  HeadwordEntry.fromJson(Map<String, dynamic> json) {
    ...
    if (json['lexicalEntries'] != null) {
      ...
      json['lexicalEntries'].forEach((v) {
        lexicalEntries.add(LexicalEntry.fromJson(v));
      });
    }
    if (json['pronunciations'] != null) {
      pronunciations = List<Pronunciation>();
      json['pronunciations'].forEach((v) {
        pronunciations.add(Pronunciation.fromJson(v));
      });
    }
    type = json['type'];
    word = json['word'];
...
class LexicalEntry {
  ...
  LexicalEntry.fromJson(Map<String, dynamic> json) {
    if (json['derivativeOf'] != null) {
      ...
      json['derivativeOf'].forEach((v) {
        derivativeOf.add(Derivative.fromJson(v));
      });
    }
    if (json['derivatives'] != null) {
      derivatives = List<Derivative>();
      json['derivatives'].forEach((v) {
        derivatives.add(Derivative.fromJson(v));
      });
    }
    ...
    if (json['grammaticalFeatures'] != null) {
      ...
      json['grammaticalFeatures'].forEach((v) {
        grammaticalFeatures.add(GrammaticalFeature.fromJson(v));
      });
    }
    language = json['language'];
    ...
    if (json['variantForms'] != null) {
      ...
      json['variantForms'].forEach((v) {
        variantForms.add(VariantForm.fromJson(v));
      });
    }
  }
}
...
class Sense {
  ...
  Sense.fromJson(Map<String, dynamic> json) {
    ...
    if (json['subsenses'] != null) {
      ...
      json['subsenses'].forEach((v) {
        subsenses.add(Sense.fromJson(v));
      });
    }
    if (json['thesaurusLinks'] != null) {
      thesaurusLinks = List<ThesaurusLink>();
      json['thesaurusLinks'].forEach((v) {
        thesaurusLinks.add(ThesaurusLink.fromJson(v));
      });
    }
  }
}
